...
/// @notice Test deposit against CREATE2 deployed contracts on Anvil fork
contract IntegrationDepositTest is Test {
    // Mainnet addresses
    address constant PERMIT2 = 0x000000000022D473030F116dDEE9F6B43aC78BA3;
    address constant USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    
    // CREATE2 deployed addresses (from deploy script)
    address constant ROUTER = 0x069dC28F2CF064560aB1C53Af00C2477E4D4c3e0;
    address constant ACCOUNT_MANAGER = 0x3cFA4ADef94403909215B1d07F6fD4034A427519;
    ...
    function setUp() public {
        // Use local Anvil fork (contracts already deployed)
        ...
        // Use the same fresh EOA as integration test
        ...
        router = PerpRouter(ROUTER);
        accountManager = AccountManager(ACCOUNT_MANAGER);
        
        console2.log("Router:", address(router));
        console2.log("AccountManager:", address(accountManager));
        console2.log("Router operator:", router.operator());
        console2.log("Our operator:", operator);
        console2.log("Depositor:", depositor);
        console2.log("Depositor USDC:", IERC20(USDC).balanceOf(depositor));
        console2.log("Depositor Permit2 allowance:", IERC20(USDC).allowance(depositor, PERMIT2));
        
        // Verify operator matches
        require(router.operator() == operator, "Operator mismatch");
        ...
        console2.log("After setup:");
        console2.log("Depositor USDC:", IERC20(USDC).balanceOf(depositor));
        console2.log("Depositor Permit2 allowance:", IERC20(USDC).allowance(depositor, PERMIT2));
    }
    
    function testDepositWithDeployedContracts() public {
